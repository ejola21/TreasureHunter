...
- (NSString *)requestUrlsync:(NSURL*)url bodyObject:(NSDictionary *)bodyObject
{
	...
	NSData *urlData;
	NSURLResponse *_response =[[[NSURLResponse alloc] init] autorelease];;
	NSError *error;
  ...
  // 통신방식 정의 (POST, GET)
	...
	urlData = [NSURLConnection sendSynchronousRequest:request returningResponse:&_response error:&error];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	if(target!= nil && selector != nil && result != nil)
	{
...
{
 NSLog(@"HttpRequest setDelegate: %@", aTarget);	
